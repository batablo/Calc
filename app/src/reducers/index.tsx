...
export const onAllClearClick = () => ({
  types: ALLCLEAR as typeof ALLCLEAR,
});
...
export type Actions =
  ...
  | ReturnType<typeof onAllClearClick>
...
export const reducer = (state: AppState, action: Actions): AppState => {
  switch (action.types) {
    ...
    case CLEAR:
      const strValue = state.inputValue.toString();
      return {
        ...state,
        inputValue: Number(strValue.substring(0, strValue.length - 1)),
        showingResult: false,
      };
